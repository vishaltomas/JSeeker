...
export function JobSearchPanel({ store, persist }: JobSearchPanelProps) {
  ...
  return (
    <section>
      <h2>Job Search — Google Jobs (SerpApi)</h2>
      ...
      <div className="field">
        <label htmlFor="set-serpapi-key">SerpApi key</label>
        <input
          id="set-serpapi-key"
          autoComplete="off"
          value={serpApiKey}
      ...
      <h2 style={{ marginTop: 22 }}>Adzuna</h2>
      <p className="section-hint">
      ...
      <div className="field">
        <label htmlFor="set-adzuna-id">App ID</label>
        <input
          id="set-adzuna-id"
          autoComplete="off"
          value={adzunaId}
      ...
      <div className="field">
        <label htmlFor="set-adzuna-key">App Key</label>
        <input
          id="set-adzuna-key"
          autoComplete="off"
          value={adzunaKey}
      ...
      <div className="field">
        <label htmlFor="set-adzuna-country">Country code</label>
        <input
